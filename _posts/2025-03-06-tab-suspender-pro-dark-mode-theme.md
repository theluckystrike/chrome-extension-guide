...
Enabling Dark Mode in Tab Suspender Pro {#enabling-dark-mode}
...
After enabling dark mode, you may want to explore additional settings within this panel. The extension often provides options to adjust the specific shade of dark used,

---

Theme Customization Options {#theme-customization-options}
...
Matching System Dark Mode Preference {#matching-system-dark-mode}
...
This automation eliminates the need to remember to switch themes manually when working in different lighting conditions or at different times of day. The transition happens smoothly in the background, ensuring your browsing environment always matches your current system theme.
...
Screenshot Guide for Each Theme {#screenshot-guide}
...
CSS Customization for Advanced Users {#css-customization}
