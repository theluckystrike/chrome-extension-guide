...
Auto-Reload on Focus: When enabled, suspended tabs automatically reload when you click on them, restoring your place smoothly. This setting provides the best user experience while still capturing memory savings during periods of inactivity.
