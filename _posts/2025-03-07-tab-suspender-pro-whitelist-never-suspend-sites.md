...
Your exported whitelist file serves multiple purposes. It provides a complete backup protecting against accidental data loss. It enables configuration sharing between different Chrome profiles on the same computer. Most importantly, it facilitates (migration) to new devices, you export from your current setup and import on your new machine.
