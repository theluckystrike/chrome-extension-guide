...
canonical_url: "https://theluckystrike.github.io/chrome-extension-guide/guides/chrome-extension-data-privacy/"
---
...
- Example: Store `user_hash: "a1b2c3d4"` instead of `email: "user@example.com"`
