...
For simpler scheduled tasks, alarms alone are sufficient. But when you need full browser context for DOM operations or complex network requests, combine alarms with offscreen documents to create robust, long-running background processes that keep your extension working smoothly for users.
