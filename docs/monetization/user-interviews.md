...
- What frustrates them about existing solutions (problems)
...
For Chrome extensions, use these channels:
...
12. "What other problems do you have that our extension could potentially address?"
...
Problem Statement
[1-2 sentences describing the user problem from interviews]
...
1. Recurring Interview Schedule
   - Quarterly: Deep detailed look interviews with 5-10 users
