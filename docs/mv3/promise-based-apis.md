...
The `@theluckystrike/webext-storage` library provides a promise-based interface that works smoothly with MV3:
...
```js
//  create() returns number|string synchronously, NOT a promise
